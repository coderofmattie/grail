...
;; 2. Implement packrat optimization.

;;    Inject into the token match function storage of successful
;;    matches.  regex matches are preceded by a check of the stack for
;;    remembered matches. The terminals need to be tagged with
