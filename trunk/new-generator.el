...
;; The Parser Function Generator is a key component to the parser
;; compiler. It generates the Match Functions from a specification of
;; parser primitives or semantics.
...
;; The flags track the semantic primitives turned on for a
;; function. They are set and adjusted by validation.

;; Code fragments are typically lists of sexps generated by
;; parser-gen-{input,ast,logic}-* before the template like expansion
;; is performed by parser-function-generate.
